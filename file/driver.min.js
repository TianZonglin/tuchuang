...
function() {
    return function(t) {
        ...
        c = function(t, e, n) {
            ...
            for (u in d && (n = e), n) h = ((l = !p && m && void 0 !== m[u]) ? m: n)[u],
    ...
    function(t, e, n) {
        ...
        (t.exports = function(t, e, n, a) {
            ...
            t[e] !== n && (u && (r(n, s) || i(n, s, t[e] ? "" + t[e] : c.join(String(e)))), t === o ? t[e] = n: a ? t[e] ? t[e] = n: i(t, e, n) : (delete t[e], i(t, e, n)))
    ...
    function(t, e, n) {
        ...
        U = function(t) {
            var e = z[t] = k(B.prototype);
            return e._k = t,
            e
        },
        Y = W && "symbol" == typeof B.iterator ?
        function(t) {
        ...
        J = function(t, e, n) {
            ...
            e = S(e, !0),
            m(n),
            i(z, e) ? (n.enumerable ? (i(t, F) && t[F][e] && (t[F][e] = !1), n = k(n, {
                enumerable: O(0, !1)
        ...
        tt = function(t) {
            for (var e, n = t === V,
            o = _(n ? D: x(t)), r = [], s = 0; o.length > s;) ! i(z, e = o[s++]) || n && !i(V, e) || r.push(z[e]);
            return r
        };
        W || (a((B = function() {
        ...
        B.prototype[I] || n(4)(B.prototype, I, B.prototype.valueOf),
        h(B, "Symbol"),
        h(Math, "Math", !0),
        h(o.JSON, "JSON", !0)
    },
    ...
    function(t, e, n) {
        ...
        t.exports = function(t, e) {
            ...
            return function(e, a, d) {
                for (var v, y, g = r(e), m = i(g), b = o(a, d, 3), w = s(m.length), x = 0, S = n ? p(e, w) : c ? p(e, 0) : void 0; w > x; x++) if ((f || x in m) && (y = b(v = m[x], x, g), t)) if (n) S[x] = y;
                else if (y) switch (t) {
                case 3:
                    return ! 0;
                case 5:
    ...
    function(t, e, n) {
        ...
        t.exports = function(t) {
            var e;
            return i(t) && ("function" != typeof(e = t.constructor) || e !== Array && !i(e.prototype) || (e = void 0), o(e) && null === (e = e[r]) && (e = void 0)),
            void 0 === e ? Array: e
        }
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
        ...
        t.exports = {
            ...
            function(t, e, o) {
                try { (o = n(22)(Function.call, n(49).f(Object.prototype, "__proto__").set, 2))(t, []),
    ...
    function(t, e, n) {
        ...
        var g = function() {
            ...
            },
            {
                ...
                value: function() {
                    ...
                    this.highlightedElement && this.highlightedElement.onDeselected(!0),
                    this.highlightedElement = null,
                    this.lastHighlightedElement = null,
                    this.node && (this.window.clearTimeout(this.hideTimer), this.options.animate && !t ? (this.node.style.opacity = "0", this.hideTimer = this.window.setTimeout(this.removeNode, 300)) : this.removeNode())
                }
            },
            {
                key: "removeNode",
        ...
        var x = function() {
            ...
            (n = [{
                key: "isInView",
                value: function() {
                    for (var t = this.node.offsetTop,
                    e = this.node.offsetLeft,
                    n = this.node.offsetWidth,
                    o = this.node.offsetHeight,
                    i = this.node; i.offsetParent;) t += (i = i.offsetParent).offsetTop,
                    e += i.offsetLeft;
            ...
            },
            {
                ...
                value: function() {
                    for (var t = this.node.parentNode; t && t.tagName && "body" !== t.tagName.toLowerCase();) {
                        ...
                        s = d(t, "filter", !0),
                        a = d(t, "perspective", !0); (/[0-9]+/.test(e) || n < 1 || o && "none" !== o || i && "flat" !== i || r && "border-box" !== r || s && "none" !== s || a && "none" !== a) && t.classList.add("driver-fix-stacking"),
                        t = t.parentNode
                    }
                }
            },
        ...
        var N = function(t) {
            function e(t, n, o) {
                ...
                } (this, P(e).call(this))).options = function(t) {
            ...
            },
            {
                ...
                value: function() {
                    ...
                    this.options.showButtons ? (t ? (this.options.showNextButton ? this.nextBtnNode.style.display = "inline-block": this.nextBtnNode.style.display = "none", this.options.showPrevButton ? this.prevBtnNode.style.display = "inline-block": this.prevBtnNode.style.display = "none", this.options.showCloseButton ? this.closeBtnNode.style.display = "inline-block": this.closeBtnNode.style.display = "none", this.closeBtnNode.classList.remove("driver-close-only-btn")) : (this.nextBtnNode.style.display = "none", this.prevBtnNode.style.display = "none", this.closeBtnNode.classList.add("driver-close-only-btn")), this.footerNode.style.display = "block", this.options.isFirst ? (this.prevBtnNode.classList.add("driver-disabled"), this.nextBtnNode.innerHTML = this.options.startBtnText) : this.prevBtnNode.classList.remove("driver-disabled"), this.options.isLast ? this.nextBtnNode.innerHTML = this.options.doneBtnText: this.nextBtnNode.innerHTML = this.options.nextBtnText) : this.footerNode.style.display = "none"
                }
            },
            {
                key: "positionOnLeft",
        ...
        var F = function() {
            ...
            },
            {
                ...
                value: function(t) {
                    if (this.isActivated && this.hasHighlightedElement()) {
                        ...
                        if (o || i || !this.options.overlayClickNext) if (o || i || !this.options.allowClose) {
            ...
            },
            {
                ...
                value: function(t) {
                    ...
                    if (!s) return console.warn("Element to highlight ".concat(i, " not found")),
                    null;
                    var a = null;
                    if (o.popover && o.popover.title) {
                        ...
                        a = new N(u, this.window, this.document)
                    }
                    var l = B({},
                    o),
                    h = new _(l, this.window, this.document);
                    return new x({
                        node: s,
                        options: o,
                        popover: a,
